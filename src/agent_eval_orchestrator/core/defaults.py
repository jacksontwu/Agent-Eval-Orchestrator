...
DEFAULT_WORKER_POST_TIMEOUT_SEC = 30
DEFAULT_WORKER_JOB_ARCHIVE_TIMEOUT_SEC = 600
DEFAULT_WORKER_FINAL_HEARTBEAT_TIMEOUT_SEC = 120
DEFAULT_SLOTS = 1
...
DEFAULT_ENVIRONMENT_DELETE = True
